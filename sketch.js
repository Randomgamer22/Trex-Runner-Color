...
function preload() {
  trex_running = loadAnimation("tile001.png", "tile002.png", "tile003.png");
  trex_collided = loadAnimation("tile000.png");
...
function setup() {
  ...
  ground = createSprite(200, windowHeight, 400, 20);
  ...
  invisibleGround = createSprite(200, windowHeight - 10, windowWidth, 10);
...
function draw() {
  ...
  if (gameState === PLAY) {
    ...
    if (keyDown("space") && trex.y >= windowHeight - 40) {
      trex.velocityY = -12;
      jumpSound.play();
    }
